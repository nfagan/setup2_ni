function run_gf_pair_train_L_Simu_stage2()
...
timing.actor_response_state_chooser_duration = 0.15;%--0.30
timing.actor_response_state_chooser_duration_left = 0.15;
timing.actor_response_state_chooser_duration_right = 0.15;
...
%         WaitSecs( timing.actor_response_reward_m1 + timing.waitSecs);
%         deliver_reward( task_interface, 0, [timing.actor_response_reward_m1] );%
%       end
    else
